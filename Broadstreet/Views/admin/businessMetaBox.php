...
<table width="100%" id="bs-meta-table" class="bs-meta-table">
    <tbody>
                ...
                <ul id="bs_image_list">
                    <?php for($i = 0; $i < count($meta['bs_images']); $i++): ?>
                        <li <?php if($i == 0) echo 'class="featured"' ?>>
                            ...
                            <input class="bs-image-input" type="hidden" name="bs_images[<?php echo (int)$i ?>]" value="<?php echo esc_attr($meta['bs_images'][$i]) ?>" />
                        </li>
                    <?php endfor; ?>
                </ul>
        ...
        <tr>
            ...
            <td><input placeholder="<?php echo esc_url(site_url()) ?>/your/review" type="text" name="bs_publisher_review" value="<?php echo esc_attr($meta['bs_publisher_review']) ?>" /></td>
        </tr>
        <tr>
