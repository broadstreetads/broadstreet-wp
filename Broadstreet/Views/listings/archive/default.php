...
<div class="biz-column-1">
    ...
    <div class="basic-info">
        <?php if($meta['bs_address']): ?>
            <?php echo esc_html(nl2br($meta['bs_address'])) ?><br />
        <?php endif; ?>
...
<div class="biz-column-2" class="boxed-sizing">
    <?php echo esc_html(wp_trim_words(strip_tags($content), 100)); ?> <a href="<?php echo esc_url(get_permalink()) ?>">Read More</a>
    <?php $day = strtolower(date('l')); ?>
    <?php if($meta["bs_{$day}_open"]): ?>
        <div><strong>Open today</strong> <?php echo esc_html($meta["bs_{$day}_open"] . ' to ' . $meta["bs_{$day}_close"]); ?>.
            <?php if($meta['bs_menu']): ?>
